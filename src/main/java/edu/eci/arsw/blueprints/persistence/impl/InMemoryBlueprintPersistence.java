...
public class InMemoryBlueprintPersistence implements BlueprintsPersistence{
    ...
    public InMemoryBlueprintPersistence() {
        ...
        Blueprint bp1=new Blueprint("David", "p1",pts1);
        Blueprint bp2=new Blueprint("Sara", "p2",pts2);
        Blueprint bp3=new Blueprint("David", "p3",pts3);
        Blueprint bp4=new Blueprint("Maria", "p4",pts4);
